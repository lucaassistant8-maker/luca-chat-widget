...
s.textContent='@import url("https://fonts.googleapis.com/css2?family=Jost:wght@300;400;500;600&display=swap");#lr *{box-sizing:border-box;margin:0;padding:0;font-family:\'Jost\',sans-serif;-webkit-font-smoothing:antialiased}:root{--ob:#1A1A1A;--cr:#E6D9C9;--bn:#F5F5F0;--bd:rgba(230,217,201,.18);--cr2:rgba(230,217,201,.12);--bn6:rgba(245,245,240,.6)}#lt{position:fixed;bottom:32px;right:32px;z-index:9998;display:flex;align-items:center;gap:10px;background:#1A1A1A;border:1px solid rgba(230,217,201,.18);color:#F5F5F0;padding:14px 22px 14px 16px;border-radius:8px;cursor:pointer;font-size:13px;font-weight:500;letter-spacing:.08em;text-transform:uppercase;transition:background .25s,transform .2s;box-shadow:0 8px 32px rgba(0,0,0,.45);user-select:none;font-family:\'Jost\',sans-serif}#lt:hover{background:#222;border-color:rgba(230,217,201,.4);transform:translateY(-2px)}.lpd{width:9px;height:9px;background:#E6D9C9;border-radius:50%;flex-shrink:0;position:relative}.lpd::after{content:"";position:absolute;inset:-4px;border-radius:50%;border:1.5px solid #E6D9C9;animation:lp 2s ease-out infinite}@keyframes lp{0%{opacity:.9;transform:scale(1)}70%{opacity:0;transform:scale(2.2)}100%{opacity:0;transform:scale(2.2)}}#lp{position:fixed;bottom:100px;right:32px;z-index:9999;width:380px;height:560px;background:#1A1A1A;border:1px solid rgba(230,217,201,.18);border-radius:8px;box-shadow:0 32px 80px rgba(0,0,0,.55),0 8px 24px rgba(0,0,0,.4);display:flex;flex-direction:column;overflow:hidden;opacity:0;transform:translateY(16px) scale(.97);pointer-events:none;transition:opacity .3s cubic-bezier(.4,0,.2,1),transform .3s cubic-bezier(.4,0,.2,1)}#lp.lo{opacity:1;transform:translateY(0) scale(1);pointer-events:all}#lh{display:flex;align-items:center;justify-content:space-between;padding:18px 20px;border-bottom:1px solid rgba(230,217,201,.18);background:rgba(255,255,255,.02);flex-shrink:0}.lhl{display:flex;align-items:center;gap:12px}.lav{width:32px;height:32px;border-radius:6px;background:rgba(230,217,201,.12);border:1px solid rgba(230,217,201,.18);display:flex;align-items:center;justify-content:center;flex-shrink:0}.lav svg{width:16px;height:16px;opacity:.85}.lnm{font-size:13px;font-weight:600;color:#F5F5F0;letter-spacing:.12em;text-transform:uppercase;font-family:\'Jost\',sans-serif}.lst{font-size:10px;color:rgba(245,245,240,.6);letter-spacing:.05em;display:flex;align-items:center;gap:5px;margin-top:2px;font-family:\'Jost\',sans-serif}.lsd{width:5px;height:5px;border-radius:50%;background:#7BC67E}#lc{background:none;border:none;cursor:pointer;color:rgba(245,245,240,.6);padding:4px;border-radius:4px;line-height:0;transition:color .2s,background .2s}#lc:hover{color:#F5F5F0;background:rgba(230,217,201,.12)}#lm{flex:1;overflow-y:auto;padding:24px 20px;display:flex;flex-direction:column;gap:16px;scrollbar-width:thin;scrollbar-color:rgba(230,217,201,.18) transparent}#lm::-webkit-scrollbar{width:4px}#lm::-webkit-scrollbar-thumb{background:rgba(230,217,201,.18);border-radius:2px}.lmsg{display:flex;flex-direction:column;max-width:88%;animation:lmi .28s ease-out both}@keyframes lmi{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}.lmsg.lu{align-self:flex-end;align-items:flex-end}.lmsg.lb{align-self:flex-start;align-items:flex-start}.lbb{padding:11px 15px;border-radius:8px;font-size:13.5px;line-height:1.65;font-weight:400;font-family:\'Jost\',sans-serif}.lu .lbb{background:#E6D9C9;color:#1A1A1A;border-bottom-right-radius:2px}.lb .lbb{background:rgba(230,217,201,.12);border:1px solid rgba(230,217,201,.18);color:#F5F5F0;border-bottom-left-radius:2px}.lmt{font-size:10px;color:rgba(245,245,240,.6);margin-top:5px;letter-spacing:.03em;font-family:\'Jost\',sans-serif}#lty{display:none;align-self:flex-start;align-items:center;gap:12px;padding:11px 15px;background:rgba(230,217,201,.12);border:1px solid rgba(230,217,201,.18);border-radius:8px;border-bottom-left-radius:2px}#lty.lv{display:flex}.ltt{font-size:12px;color:rgba(245,245,240,.6);letter-spacing:.04em;font-style:italic;font-family:\'Jost\',sans-serif}.lds{display:flex;gap:4px}.lds span{width:4px;height:4px;border-radius:50%;background:#E6D9C9;animation:ld 1.3s ease-in-out infinite}.lds span:nth-child(2){animation-delay:.2s}.lds span:nth-child(3){animation-delay:.4s}@keyframes ld{0%,60%,100%{opacity:.25;transform:scale(.9)}30%{opacity:1;transform:scale(1.2)}}#lf{border-top:1px solid rgba(230,217,201,.18);padding:14px 16px;background:rgba(255,255,255,.015);flex-shrink:0}.lir{display:flex;align-items:flex-end;gap:10px;background:rgba(230,217,201,.12);border:1px solid rgba(230,217,201,.18);border-radius:8px;padding:10px 12px;transition:border-color .2s}.lir:focus-within{border-color:rgba(230,217,201,.45)}#li{flex:1;background:none;border:none;outline:none;color:#F5F5F0;font-size:13.5px;font-family:\'Jost\',sans-serif;resize:none;max-height:100px;overflow-y:auto;scrollbar-width:none}#li::placeholder{color:rgba(245,245,240,.6);font-style:italic}#ls{background:#E6D9C9;border:none;border-radius:6px;width:32px;height:32px;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:background .2s,transform .15s;line-height:0}#ls:hover{background:#F5F5F0;transform:scale(1.05)}#ls:disabled{opacity:.4;cursor:not-allowed;transform:none}#ls svg{width:15px;height:15px}.lhi{font-size:10px;color:rgba(245,245,240,.6);text-align:center;margin-top:8px;letter-spacing:.03em;font-family:\'Jost\',sans-serif}@media(max-width:480px){#lp{right:12px;left:12px;width:auto;bottom:90px}#lt{right:16px;bottom:20px}}';
